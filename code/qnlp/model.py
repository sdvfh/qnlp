...
class ModelHandler:
    models = {
        ...
        "PCDQN_1.0_0.0": construct_parametric(tau=1.0, delta=np.pi / 2 * 1.0),
        "PCDQN_1.0_0.2": construct_parametric(tau=1.0, delta=np.pi / 2 * 1.0),
        "PCDQN_1.0_0.3": construct_parametric(tau=1.0, delta=np.pi / 2 * 1.0),
        "PCDQN_1.0_0.4": construct_parametric(tau=1.0, delta=np.pi / 2 * 1.0),
        "PCDQN_0.6_0.0": construct_parametric(tau=0.6, delta=np.pi / 2 * 0.0),
        "PCDQN_0.6_0.1": construct_parametric(tau=0.6, delta=np.pi / 2 * 0.1),
        "PCDQN_0.6_0.2": construct_parametric(tau=0.6, delta=np.pi / 2 * 0.2),
        "PCDQN_0.6_0.3": construct_parametric(tau=0.6, delta=np.pi / 2 * 0.3),
        "PCDQN_0.6_0.4": construct_parametric(tau=0.6, delta=np.pi / 2 * 0.4),
        "PCDQN_0.6_0.5": construct_parametric(tau=0.6, delta=np.pi / 2 * 0.5),
        "PCDQN_0.4_0.0": construct_parametric(tau=0.4, delta=np.pi / 2 * 0.0),
        "PCDQN_0.4_0.1": construct_parametric(tau=0.4, delta=np.pi / 2 * 0.1),
        "PCDQN_0.4_0.2": construct_parametric(tau=0.4, delta=np.pi / 2 * 0.2),
        "PCDQN_0.4_0.3": construct_parametric(tau=0.4, delta=np.pi / 2 * 0.3),
        "PCDQN_0.4_0.4": construct_parametric(tau=0.4, delta=np.pi / 2 * 0.4),
        "PCDQN_0.4_0.5": construct_parametric(tau=0.4, delta=np.pi / 2 * 0.5),
        "PCDQN_0.9_0.0": construct_parametric(tau=0.9, delta=np.pi / 2 * 0.0),
        "PCDQN_0.9_0.1": construct_parametric(tau=0.9, delta=np.pi / 2 * 0.1),
        "PCDQN_0.9_0.2": construct_parametric(tau=0.9, delta=np.pi / 2 * 0.2),
        "PCDQN_0.9_0.3": construct_parametric(tau=0.9, delta=np.pi / 2 * 0.3),
        "PCDQN_0.9_0.4": construct_parametric(tau=0.9, delta=np.pi / 2 * 0.4),
        "PCDQN_0.9_0.5": construct_parametric(tau=0.9, delta=np.pi / 2 * 0.5),
        "PCDQN_1.1_0.0": construct_parametric(tau=1.1, delta=np.pi / 2 * 0.0),
        "PCDQN_1.1_0.1": construct_parametric(tau=1.1, delta=np.pi / 2 * 0.1),
        "PCDQN_1.1_0.2": construct_parametric(tau=1.1, delta=np.pi / 2 * 0.2),
        "PCDQN_1.1_0.3": construct_parametric(tau=1.1, delta=np.pi / 2 * 0.3),
        "PCDQN_1.1_0.4": construct_parametric(tau=1.1, delta=np.pi / 2 * 0.4),
        "PCDQN_1.1_0.5": construct_parametric(tau=1.1, delta=np.pi / 2 * 0.5),
