...
#   for classifier in "${classical_classifiers[@]}"; do
#     for layers in 1; do
#       python experiments.py -dataset "$dataset" -model_transformer "all-mpnet-base-v2" -n_features 768  --n_qubits 10  -model_classifier "$classifier" --epochs 40 --batch_size 512 --n_repetitions 30 --n_layers "$layers" ;
#     done
#   done
# done
#
